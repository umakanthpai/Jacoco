...
public class ReportGenerator {
	...
	public ReportGenerator(final File projectDirectory) {
		...
		this.executionDataFile = new File(projectDirectory, "testJacoco1.exec");
		this.classesDirectory = new File(projectDirectory, "bin");
		//this.classesDirectory = new File("d:\\tmp\\classdir");
		
		this.sourceDirectory = new File(projectDirectory, "src");
		
		//this.sourceDirectory = new File("d:\\tmp\\sourcedir\\");
